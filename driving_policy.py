...
class DiscreteDrivingPolicy(nn.Module):
    ...
    def __init__(self, n_classes):
        ...
        self.features = nn.Sequential(
            #
            # YOUR CODE GOES HERE
            nn.Conv2d(3, 24, kernel_size=4, stride=2, padding=1), # outputs (24, 64, 64)
            nn.ReLU(),
            nn.Conv2d(24, 36, kernel_size=4, stride=2, padding=1), # outputs (36, 32, 32)
            nn.ReLU(),
            nn.Conv2d(36, 48, kernel_size=4, stride=2, padding=1), # outputs (48, 16, 16)
            nn.ReLU(),
            nn.Conv2d(48, 64, kernel_size=4, stride=2, padding=1), # outputs (64, 8, 8)
            nn.ReLU(),
            #
        ...
        self.classifier = nn.Sequential(
            ...
            # nn.ReLU(), # got better results by excluding the relu, please uncomment if you wish to include in architecture.
            #
        )  
